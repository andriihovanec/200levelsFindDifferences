	...
	private static final int[] hidden_hints_data = new int[]
{
    ...
    public void onCreate(SQLiteDatabase db) {
      ...
      */
	  ...
	  //db.execSQL("DROP TABLE IF EXISTS " + TABLE_DIFFERENCES);
      ...
      /*
      insert_query = "INSERT INTO " + TABLE_LEVELS + " VALUES(";
      int data_len = levels_data.length - 1;
      int i = 0;
      int id = 0;
      */
      /*
      do{
          db.execSQL(insert_query + "'"+ id+1 +"','"+ levels_data[i] +"','"+ levels_data[i+1] 
        		  +"','"+ levels_data[i+2] +"','"+ levels_data[i+3] +"','0');");
    	  i+=4;
    	  id++;
      }while (data_len > i);
      */
...
/*
	...
	public void upgrade_v1(SQLiteDatabase db) {

		String insert_query = "INSERT INTO " + TABLE_DIFFERENCES + " VALUES(";
        db.execSQL(insert_query + "'1500','61','335','315','40','0','2');");
		...
		values.put(KEY_X, String.valueOf(345));
		values.put(KEY_Y, String.valueOf(486));
		values.put(KEY_R, String.valueOf(30));
		db.update(TABLE_DIFFERENCES, values, KEY_ID + "=?",
				new String[] { "285" });
		
	}
	
	//  јпгрейд базы 2			117,175,252,35,
	public void upgrade_v2(SQLiteDatabase db) {

		String insert_query = "INSERT INTO " + TABLE_DIFFERENCES + " VALUES(";
        db.execSQL(insert_query + "'1499','117','175','252','35','0','2');");
...
/*
	...
	public void upgrade_v2(SQLiteDatabase db) {
		...
		String insert_query = "INSERT INTO " + TABLE_DIFFERENCES + " VALUES(";
	      int data_len = differences_data3.length - 1;
	      int i = 0;
	      int id = 300;
	      do{
	          db.execSQL(insert_query + "'"+ id +"','"+ differences_data3[i] +"','"+ differences_data3[i+1] 
	        		  +"','"+ differences_data3[i+2] +"','"+ differences_data3[i+3] +"','0','2');");
	    	  i+=4;
	    	  id++;
	      }while (data_len > i);
	...
	*/
    ...
    public void getLevel(Levels level, int id) {
	    //List<Levels> level = new ArrayList<Levels>();
	    // Select All Query    
	 ...
	 */
	    ...
	    if (cursor.moveToFirst()) {
	        do {
	        	...
	        	level.setPhoneNumber(cursor.getString(2));
    ...
    public int getHintCount(){
		...
		//Log.e("getHintCount", String.valueOf(hintcount));
	    return hintcount;
    }
    
    public void addHint(int addcount){

		//Log.e("addHint", String.valueOf(addcount));
	    SQLiteDatabase db = this.getWritableDatabase();
    ...
    public void subtractOneHint(){
		...
		//Log.e("subtractOneHint", String.valueOf(count));
    	ContentValues values = new ContentValues();
		values.put(VALUE, String.valueOf(count));
		db.update(TABLE_SETTINGS, values, KEY_ID + "=?",
				new String[] { "3" });
    ...
    public HiddenHintData getHiddenHint(int lvl) {
	    ...
	    if (cursor.moveToFirst()) {
			...
			/*
			hiddenHint = new HiddenHint(finalX, finalY, xx, yy, sc);
	        differences.setX(cursor.getInt(0));
	        differences.setY(cursor.getInt(1));
	        differences.setR(cursor.getInt(2));
	        differences.setFinded(cursor.getInt(3));
	        */
	    }
		return hhd;
    }
